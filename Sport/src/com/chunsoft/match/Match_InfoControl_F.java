...
public class Match_InfoControl_F extends Fragment implements
		SwipeRefreshLayout.OnRefreshListener {
	@Bind(R.id.web_match_change_data)
	WebView mWebView;
	@Bind(R.id.match_swipe_data)
	...
	private void init() {
		...
		String url = Constant.IP + Constant.ODD_CHANGES;
