...
public class DateSelect_A extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		calendar.setOnItemClickListener(new OnItemClickListener() {
			...
			public void OnItemClick(Date selectedStartDate,
				...
				Intent intent = new Intent(DateSelect_A.this,
						RecommendResult_FA.class);
				intent.putExtra("date1", format.format(downDate));
				setResult(0, intent);
				DateSelect_A.this.finish();
			}
		});
